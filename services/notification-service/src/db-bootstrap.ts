...
export async function bootstrapDatabase(pool: Pool): Promise<void> {
  ...
  await pool.query(`
    ...
    CREATE TABLE IF NOT EXISTS notification_templates (
      ...
      channels TEXT[] NOT NULL DEFAULT '{}', subject_tpl TEXT, body_tpl TEXT NOT NULL,
    ...
    CREATE TABLE IF NOT EXISTS notification_log (
      ...
      subject TEXT, body TEXT, status VARCHAR(50) NOT NULL DEFAULT 'SENT',
...
async function seedData(pool: Pool): Promise<void> {
  ...
  for (const [code, name, channels, subject, body] of templates) {
    await pool.query(
      `INSERT INTO notification_templates (tenant_id,code,name,channels,subject_tpl,body_tpl,active) VALUES ($1,$2,$3,$4,$5,$6,TRUE) ON CONFLICT DO NOTHING`,
